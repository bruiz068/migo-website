      ...
      faqs: [
        {
          ...
          answer: "We offer three Impression Packs: Starter ($149/mo, 500 impressions), Growth ($349/mo, 1,500 impressions), and Pro ($799/mo, 4,000 impressions). Save more with quarterly billing. Need extra impressions? Buy a Boost Pack anytime starting at $99."
        },
        {
        ...
        },
        {
          ...
          answer: "All plans are month-to-month with no long-term contracts. Cancel anytime. Quarterly billing is available at a discounted rate."
        },
        {
          question: "Do you guarantee impression counts?",
          answer: "Each pack includes a guaranteed number of impressions. Your ads play until your balance is used up. When it hits zero, ads pause until your next renewal or a Boost purchase. You always get what you pay for."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "We're live in Phoenix with active tablets on the road. Our network continues to grow with new drivers joining regularly. We plan to expand to additional cities based on demand."
        },
        {
          question: "Do you offer discounts for longer commitments?",
          answer: "Yes! Quarterly billing saves up to 17% compared to monthly. We also offer custom enterprise pricing for multi-location brands and agencies."
        },
        {
          question: "How does billing work?",
          answer: "Simple monthly or quarterly billing via credit card. Each plan includes a set number of impressions. When your balance runs out, ads pause until your next renewal or a Boost purchase. No surprises."
        },
        {
